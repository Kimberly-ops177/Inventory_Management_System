...
try {
    ...
    $pdo->exec("TRUNCATE TABLE stock_alerts");
    ...
    foreach ($products as $prodData) {
        ...
        echo "  ✓ {$prodData['name']} (KES {$prodData['sale_price']})\n";
    }
    ...
    echo "\n✓ Kenyan products seeded successfully!\n";
    echo "\n=== Summary ===\n";
    echo "Categories: 4\n";
    echo "Suppliers: 4 (Kenyan)\n";
    echo "Products: 18 (Day-to-day Kenyan goods)\n";
    echo "Initial stock: Added\n";
